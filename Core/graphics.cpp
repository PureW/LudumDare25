 ...
 *  More details
 */
bool Renderer::initWindow(int _width, int _height, int bpp, int _mode, char* title)
{
	width	= _width;
	height	= _height;
	if (bpp%3)
...
void Renderer::drawRectangle( int x, int y, int w, int h, float r, float g, float b, float alpha )
{
...
grError Renderer::loadTexture( char* file, gType type, texture* text )
{
...
void Renderer::drawSprite( texture* sprite, int x, int y, float rotation, float blended )
{
...
void Renderer::drawSprite( texture* sprite, int x, int y)
{
	drawSprite( sprite, x, y, sprite->width, sprite->height, 0.0, 1.0 );
}


void Renderer::drawSprite( texture* sprite, int x, int y, int w, int h, float rotation, float blended )
{
...
void Renderer::drawSprite( texture* sprite, int x, int y, int w, int h)
{
    float colour=1;
